...
<?php $__env->startSection('content'); ?>
    <h2 class="title-bar no-border-bottom">
        <?php echo e($row->id ? __('Edit: ').$row->title : __('Add new Travel agent')); ?>
        ...
        <form action="<?php echo e(route('space.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <?php endif; ?>
                    <a data-toggle="tab" href="#booking-link" aria-selected="false">6. <?php echo e(__('Website & Booking')); ?></a>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="booking-link">
                            <?php echo $__env->make('Space::admin/space/booking_url', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/travel/themes/Base/Space/Views/frontend/manageSpace/detail.blade.php ENDPATH**/ ?>