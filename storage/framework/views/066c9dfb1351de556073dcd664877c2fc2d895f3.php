<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="form-group">
        <input type="tel" class="form-control bravo-intl-phone" name="phone" autocomplete="tel" placeholder="<?php echo e(__('Phone')); ?>">
...
<?php /**PATH /var/www/html/travel/modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>