<div class="panel">
    ...
    <div class="panel-body">
        <div class="form-group">
            ...
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Name of the travel agent")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label><?php echo e(__("Staff")); ?></label>
...
<?php endif; ?><?php /**PATH /var/www/html/travel/modules/Space/Views/admin/space/content.blade.php ENDPATH**/ ?>