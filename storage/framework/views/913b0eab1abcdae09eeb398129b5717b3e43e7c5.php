<div class="bravo_header">
            ...
            <div class="header-left">
                <a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="bravo-logo">
                    ...
                    <?php if($logo_id): ?>
                        ...
                        <img class="site-logo-img" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
                    <?php endif; ?>
                </a>
    ...
    <div class="bravo-menu-mobile" style="display:none;">
        ...
        <div class="g-menu g-menu-sidebar-only">
            <?php generate_menu('primary') ?>
        </div>
    </div>
</div>
<?php /**PATH /var/www/html/travel/modules/Layout/parts/header.blade.php ENDPATH**/ ?>