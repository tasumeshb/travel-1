...
<div class="panel">
    ...
    <div class="panel-body">
        <?php if(is_default_lang()): ?>
            <div class="row">
                <?php echo $__env->make('Core::admin.components.price-with-currency', [
                    'row' => $row,
                    'field' => 'price',
                    'label' => __('Price'),
                    'placeholder' => __('Event Price'),
                    'colClass' => 'col-lg-6',
                ...
                <?php echo $__env->make('Core::admin.components.price-with-currency', [
                    ...
                    'field' => 'sale_price',
                    'label' => __('Sale Price'),
                    'placeholder' => __('Event Sale Price'),
                    'colClass' => 'col-lg-6',
                ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/travel/modules/Event/Views/admin/event/pricing.blade.php ENDPATH**/ ?>