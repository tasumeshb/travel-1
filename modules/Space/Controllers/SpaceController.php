        ...
        if ($is_ajax) {
            return $this->sendSuccess([
                ...
                'fragments'=>[
                    ...
                    '.result-count'=>$list->total() ? ($list->total() > 1 ? __(":count agents found",['count'=>$list->total()]) : __(":count space found",['count'=>$list->total()])) : '',
                    '.count-string'=> $list->total() ? __("Showing :from - :to of :total Agents",["from"=>$list->firstItem(),"to"=>$list->lastItem(),"total"=>$list->total()]) : ''
                ]
            ]);
        }
        $data = [
        ...
        public function searchServices(Request $request)
{
    ...
    $services = Space::where('title', 'LIKE', "{$query}%")
        ->take(5) 
        ->get();
