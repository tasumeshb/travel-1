                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="days" class="form-control" value="{{$row->days}}" placeholder="No.of Days"  aria-describedby="basic-addon2">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="nights" class="form-control" value="{{$row->nights}}" placeholder="No.of Night"  aria-describedby="basic-addon2">
                                <div class="input-group-append">
...
<input type="text" id="departure" name="departure" class="form-control" value="{{$row->departure}}" placeholder="departure">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">Destination</label>
<input type="text" id="destination" name="destination" class="form-control" value="{{$row->destination}}" placeholder="Destination">
                    </div>
                </div>
            </div>
