        ...
        if ($is_ajax) {
            return $this->sendSuccess([
                ...
                'fragments'=>[
                    ...
                    '.result-count'=>$list->total() ? ($list->total() > 1 ? __(":count members found",['count'=>$list->total()]) : __(":count member found",['count'=>$list->total()])) : '',
                    '.count-string'=> $list->total() ? __("Showing :from - :to of :total Members",["from"=>$list->firstItem(),"to"=>$list->lastItem(),"total"=>$list->total()]) : ''
                ]
            ]);
        }
        $data = [
