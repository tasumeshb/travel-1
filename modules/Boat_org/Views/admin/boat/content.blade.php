<div class="panel">
    <div class="panel-title"><strong>{{__("Travel Details")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label>{{__("Traveller Name")}}</label>
            <input type="text" value="{!! clean($translation->title) !!}" placeholder="{{__("Name of the traveller")}}" name="title" class="form-control">
        </div>
        <div class="form-group">
            <label class="control-label">{{__("Travel story")}}</label>
            <div class="">
        ...
        <div class="form-group-item">
            ...
            <div class="g-items-header">
                <div class="row">
                    <div class="col-md-5">{{__("Traveller Title")}}</div>
                    <div class="col-md-5">{{__('Travel content')}}</div>
    ...
    <div class="panel-body">
        @if(is_default_lang())
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{__("Fellow Passengers")}}</label>
                        <input type="number" value="{{$row->max_guest}}" placeholder="{{__("Fellow Passengers")}}" name="max_guest" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{__("Travel Duration")}}</label>
                        <input type="text" value="{{$row->cabin}}" placeholder="{{__("Travel Duration")}}" name="cabin" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>{{__("Travel Type")}}</label>
                        <input type="number" value="{{$row->length}}" placeholder="{{__("Travel Type")}}" name="length" class="form-control">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
        ...
        @endif
        <div class="form-group-item">
            <label class="control-label">{{__('Travel Features')}}</label>
            <div class="g-items-header">
                <div class="row">
        ...
        <div class="form-group">
            <label>{{__("Additional Travel Information")}}</label>
