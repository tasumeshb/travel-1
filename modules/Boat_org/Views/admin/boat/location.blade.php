<div class="panel">
    <div class="panel-title"><strong>{{__("Travel Locations")}}</strong></div>
    <div class="panel-body">
        @if(is_default_lang())
            <div class="form-group">
                <label class="control-label">{{__("Travel Location")}}</label>
        ...
        @endif
        <div class="form-group">
            <label class="control-label">{{__("Destination address")}}</label>
