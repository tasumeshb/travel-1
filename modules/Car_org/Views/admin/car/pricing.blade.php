    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label class="control-label">{{__("Number of Travellers")}}</label>
                        <input type="number" step="any" min="0" name="number" class="form-control" value="{{$row->number}}" placeholder="{{__("Number of Travellers")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Price")}}</label>
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Travel Cost")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Accomodation cost")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Accomodation cost")}}">
        ...
        @if(is_default_lang())
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Number of travel days")}}</label>
                ...
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Fellow travellers")}}</label>
