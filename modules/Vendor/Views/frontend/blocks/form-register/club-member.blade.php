    ...
    <div class="bravo-vendor-form-register py-5 @if(!empty($layout)) {{ $layout }} @endif">
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor" method="post" action="{{route('clubmember.register')}}">
                    @csrf
                    ...
                    <div class="form-group">
                        <input type="tel" class="form-control bravo-intl-phone" name="phone" autocomplete="tel" placeholder="{{__("Phone")}}">
