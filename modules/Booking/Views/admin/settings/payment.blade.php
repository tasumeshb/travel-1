                                            ...
                                            <div class="col-md-11">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p><i>{{__('Example: Main currency is USD, extra currency is INR — use a small rate (e.g. 0.010527), not 85 or 95. Formula: rate = 1 ÷ (INR per 1 USD). So 1413 USD at ~95 INR/USD → rate ≈ 0.010527 → display ≈ ₹134,225.')}}</i></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
