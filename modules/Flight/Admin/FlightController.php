<?php
    ...
    public function create(Request $request)
    {
        ...
        $data = [
            ...
            'breadcrumbs'    => [
                [
                    'name' => __('Travel Insurance'),
                    'url'  => route('flight.admin.index')
                ],
                [
                    'name'  => __('Add Travel Insurance'),
                    'class' => 'active'
                ],
            ],
            'page_title'     => __("Add new Travel Insurance")
        ];
        ...
        public function store(Request $request, $id)
        {
            ...
            if ($res) {
                ...
                if ($id > 0) {
                    return back()->with('success', __('Travel Insurance updated'));
                } else {
                    return redirect(route('flight.admin.edit', $row->id))->with('success', __('Travel Insurance created'));
                }
            }
        }
