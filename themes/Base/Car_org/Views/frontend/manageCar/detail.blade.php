...
@section('content')
    <h2 class="title-bar no-border-bottom">
        {{$row->id ? __('Edit: ').$row->title : __('Add new ')}}
    </h2>
        ...
        <form action="{{route('car.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    <a data-toggle="tab" href="#nav-tour-content" aria-selected="true" class="active">{{__("1. Travel Story")}}</a>
                    ...
                    @endif
                    <a data-toggle="tab" href="#booking-link" aria-selected="false">6. Traveller Website</a>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="booking-link">
                            @include('Car::admin/car/booking_url')
                        </div>
                </div>
            </div>
