...
@section('content')
    <h2 class="title-bar no-border-bottom">
        {{$row->id ? __('Edit: ').$row->title : __('Add New Traveller')}}
    </h2>
        ...
        <form action="{{route('boat.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
            ...
            <div class="form-add-service">
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    ...
                    <a data-toggle="tab" href="#nav-tour-location" aria-selected="false">{{__("2. Travel Locations")}}</a>
                    <a data-toggle="tab" href="#nav-tour-pricing" aria-selected="false">{{__("3. Travel Cost")}}</a>
                    @if(is_default_lang())
                        <a data-toggle="tab" href="#nav-attribute" aria-selected="false">{{__("4. Attributes")}}</a>
                    @endif
                    <a data-toggle="tab" href="#booking-link" aria-selected="false">5. Traveller Website</a>
                </div>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade" id="booking-link">
                            @include('Boat::admin/boat/booking_url')
                        </div>
                </div>
            </div>
