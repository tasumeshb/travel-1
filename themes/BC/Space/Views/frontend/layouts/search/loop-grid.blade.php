...
<div class="item-loop item-loop-wrap {{$wrap_class ?? ''}}">
    ...
    <div class="amenities">
        ...
        @endif
        @if($row->bed)
            <span class="amenity bed" data-toggle="tooltip" title="{{__("Yeays of experience")}}">
                <i class="input-icon field-icon icofont-hotel"></i> {{$row->bed}}
            </span>
        @endif
        @if($row->bathroom)
            <span class="amenity bath" data-toggle="tooltip" title="{{__("Staff")}}" >
                <i class="input-icon field-icon icofont-bathtub"></i> {{$row->bathroom}}
            </span>
        @endif
        @if($row->square)
            <span class="amenity size" data-toggle="tooltip" title="{{__("Vehicle")}}" >
