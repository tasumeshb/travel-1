(function ($) {
    if (document.getElementById('hotel-rooms')) {
    var hotelRoomForm = new Vue({
        ...
        created:function(){
            ...
            if($(this.$el).find('.form-book').length){
            ...
            doEnquirySubmit:function(e){
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        phone:(window.BravoPhoneIntl && BravoPhoneIntl.getValueByName('enquiry_phone', document.getElementById('enquiry_form_modal'))) || this.enquiry_phone,
